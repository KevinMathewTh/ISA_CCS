...
<body>
    ...
    foreach ($questions as $question) {
      ...
      // echo $question;
      $sql = "SELECT question,opt_a,opt_b,opt_c,opt_d FROM d1_mcqbank WHERE id=".$question."";
      $result = $connect->query($sql);
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo '<form id="questionscript" method="POST">
    ...
    if($_POST['submit'])  
  {
    ...
    $sql = "INSERT INTO d1_data (email, question, answer) VALUES ('$usr_email','$serialized_questions', '$serialized_answers')";

if ($connect->query($sql) === TRUE) {
  echo "New record created successfully";
          $sql = "UPDATE users SET d1=1 WHERE email='$usr_email'";
...
//    document.getElementById("questionscript").submit();
